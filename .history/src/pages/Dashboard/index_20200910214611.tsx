...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    async function loadTransactions(): Promise<void> {
      ...
      const formatedTransaction = await transaction.data.transactions.map(
  ...
  // console.log(transactions.category.title);
      ...
      <Container>
        ...
        <TableContainer>
          <table>
            ...
            <tbody>
              {await transactions.map(transaction => console.log(transaction))}
            </tbody>
          </table>
        </TableContainer>
      </Container>
